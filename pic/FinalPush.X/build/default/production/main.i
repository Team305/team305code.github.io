...
void main(void)
{
    ...
    while (1)
    {
        data1[0] = I2C2_Read1ByteRegister(0x39, 0x95);
        data1[1] = I2C2_Read1ByteRegister(0x39, 0x96);

        data[0] = I2C2_Read1ByteRegister(0x39, 0xAD);
        data[1] = I2C2_Read1ByteRegister(0x39, 0xAE);
        ID = I2C2_Read1ByteRegister(0x39, 0x5A);
...
void Enable_LS(void){
    ...
    I2C2_Write1ByteRegister(0x39,0x80, 0b00011011);
