...
void main(void)
{
    ...
    while (1)
    {
        ...
        lightBytes[0] = I2C2_Read1ByteRegister(0x39, 0x95);
        lightBytes[1] = I2C2_Read1ByteRegister(0x39, 0x96);
        lightData[0] = I2C2_Read1ByteRegister(0x39, 0xAD);
        lightData[1] = I2C2_Read1ByteRegister(0x39, 0xAE);
